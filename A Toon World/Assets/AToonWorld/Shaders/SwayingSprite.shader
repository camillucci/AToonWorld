Shader "Custom/Swaying Sprite" 
{
    Properties 
    {
        ...
        _UniformSway ("Uniform Sway Ammount", Range(0,1)) = 0
    ...
    {
        //Waving calculation
        half waveAmplitude = (1 - _UniformSway) * (_Amplitude * clamp((v.vertex.y - _MinY) / (_MaxY - _MinY), 0, 1)) + _UniformSway * _Amplitude;
        v.vertex.x += (1 - sin(v.vertex.y/_Dampening + _Time.y * _Frequency)) * waveAmplitude;
